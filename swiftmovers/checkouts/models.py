...
# TODO : add the required payment and product models

def get_default_country():
    return settings.DEFAULT_COUNTRY


class DeliveryCheckout(models.Model):
    """A delivery checkout."""
    ...
    # could tax fees and charges are captured here
...
class CheckoutLine(models.Model):
    ...
    checkout = models.ForeignKey(
        DeliveryCheckout, related_name="lines", on_delete=models.CASCADE
    )
