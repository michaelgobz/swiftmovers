# Generated by Django 3.2.19 on 2023-06-04 20:06
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('unit', models.CharField(blank=True, choices=[('cm', 'cm'), ('m', 'm'), ('km', 'km'), ('ft', 'ft'), ('yd', 'yd'), ('inch', 'inch'), ('sq_cm', 'sq_cm'), ('sq_m', 'sq_m'), ('sq_km', 'sq_km'), ('sq_ft', 'sq_ft'), ('sq_yd', 'sq_yd'), ('sq_inch', 'sq_inch'), ('cubic_millimeter', 'cubic_millimeter'), ('cubic_centimeter', 'cubic_centimeter'), ('cubic_decimeter', 'cubic_decimeter'), ('cubic_meter', 'cubic_meter'), ('liter', 'liter'), ('cubic_foot', 'cubic_foot'), ('cubic_inch', 'cubic_inch'), ('cubic_yard', 'cubic_yard'), ('qt', 'qt'), ('pint', 'pint'), ('fl_oz', 'fl_oz'), ('acre_in', 'acre_in'), ('acre_ft', 'acre_ft'), ('g', 'g'), ('lb', 'lb'), ('oz', 'oz'), ('kg', 'kg'), ('tonne', 'tonne')], max_length=100, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('rich_text', swiftmovers.core.db.fields.SanitizedJSONField(blank=True, null=True, sanitizer=swiftmovers.core.utils.editorjs.clean_editor_js)),
