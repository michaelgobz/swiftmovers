...
def authorize(
    ...
    # The swiftmovers token is the authorize.net "opaque data"
    ...
    # It is not the swiftmovers user id.
    customer_id = (
...
def _authorize_net_account_to_payment_method_info(
    ...
    """Transform Authorize.Net transactionResponse to swiftmovers credit card.
...
def _normalize_last_4(account_number: str):
    """Convert authorize.net account number to swiftmovers "last_4" format.
