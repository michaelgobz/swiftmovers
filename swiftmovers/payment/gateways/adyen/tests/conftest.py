...
def adyen_plugin(settings, channel_USD):
    def fun(
        ...
        merchant_account = merchant_account or "swiftmoversECOM"
        ...
        settings.PLUGINS = ["swiftmovers.payment.gateways.adyen.plugin.AdyenGatewayPlugin"]
        manager = get_plugins_manager()

        with mock.patch("swiftmovers.payment.gateways.adyen.utils.apple_pay.requests.post"):
...
def notification():
    def fun(
        ...
        return {
            ...
            "merchantAccountCode": "swiftmoversECOM",
...
def notification_with_hmac_signature():
    return {
        ...
        "merchantAccountCode": "swiftmoversPOS",
