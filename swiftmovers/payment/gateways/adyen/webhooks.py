...
def get_or_create_adyen_partial_payments(
    ...
    This is a workaround for not supporting partial payments in swiftmovers. Adyen can
    ...
    swiftmovers logic. We're going to change it by introducing partial payments feature on
    swiftmovers side.
    """
    additional_data = notification.get("additionalData", {})
    new_payments = []
...
def handle_additional_actions(
    ...
    back to storefront, the request goes through the swiftmovers. We use the data received
...
def confirm_payment_and_set_back_to_confirm(payment, manager, channel_slug):
    ...
    # something more on swiftmovers side (ACTION_TO_CONFIRM), it's create an order in
    ...
    #    then.
    #
    # This fix is related to swiftmovers-4777. PR #8471
