...
class AdyenGatewayPlugin(BasePlugin):
    ...
    CONFIG_STRUCTURE = {
        ...
        "adyen-auto-capture": {
            ...
            "help_text": (
                ...
                " swiftmovers doesn't support the delayed capture Adyen feature."
            ),
        ...
        "auto-capture": {
            "type": ConfigurationTypeField.BOOLEAN,
            "help_text": (
                "If enabled, swiftmovers will automatically capture funds. If, disabled, the"
        ...
        "enable-native-3d-secure": {
            "type": ConfigurationTypeField.BOOLEAN,
            "help_text": (
                "swiftmovers uses 3D Secure redirect authentication by default. If you want"
    ...
    def webhook(self, request: WSGIRequest, path: str, previous_value) -> HttpResponse:
        ...
        The method handles two types of requests:
            ...
            The redirect request comes through the swiftmovers which calls Adyen API to
    ...
    def _process_additional_action(self, payment_information: "PaymentData", kind: str):
        ...
        if result_code in PENDING_STATUSES:
            ...
            # For enabled auto_capture on swiftmovers side we need to proceed an additional
            # action
            kind = TransactionKind.CAPTURE
            result = call_capture(
                payment_information=payment_information,
