    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('modified_at', models.DateTimeField(auto_now=True)),
                ('status', models.CharField(blank=True, default='', max_length=512, null=True)),
                ...
                ('available_actions', django.contrib.postgres.fields.ArrayField(base_field=models.CharField(choices=[('charge', 'Charge payment'), ('refund', 'Refund payment'), ('void', 'Void payment'), ('cancel', 'Cancel payment')], max_length=128), default=list, size=None)),
                ('currency', models.CharField(max_length=3)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(blank=True, choices=[('pending', 'Pending'), ('success', 'Success'), ('failure', 'Failure')], default='success', max_length=128, null=True)),
                ('psp_reference', models.CharField(blank=True, max_length=512, null=True)),
                ('message', models.CharField(blank=True, default='', max_length=512, null=True)),
                ('external_url', models.URLField(blank=True, null=True)),
                ('currency', models.CharField(max_length=3)),
        ...
        migrations.AddIndex(
            model_name='transactionitem',
            index=django.contrib.postgres.indexes.GinIndex(fields=['order_id', 'status'], name='payment_tra_order_i_e783c4_gin'),
        ),
        migrations.AddIndex(
            model_name='payment',
