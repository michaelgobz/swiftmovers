...
DEPRECATED_IN_3X_FIELD = "This field will be removed in swiftmovers 4.0."
PREVIEW_FEATURE_DEPRECATED_IN_313_FIELD = (
    "This field will be removed in swiftmovers 3.14 (Preview Feature)."
)
...
PREVIEW_FEATURE_DEPRECATED_IN_313_INPUT = (
    "\n\nDEPRECATED: this field will be removed in swiftmovers 3.14 (Preview Feature)."
)

DEPRECATED_IN_3X_MUTATION = (
    "\n\nDEPRECATED: this mutation will be removed in swiftmovers 4.0."
)
...
CHANNEL_REQUIRED = (
    "\n\nThis option requires a tenant filter to work as the values can vary "
    "between channels."
)
