...
WEBHOOK_EVENT_DESCRIPTION = {
    ...
    WebhookEventAsyncType.CHANNEL_CREATED: "A new tenant created.",
    WebhookEventAsyncType.CHANNEL_UPDATED: "A tenant is updated.",
    WebhookEventAsyncType.CHANNEL_DELETED: "A tenant is deleted.",
    WebhookEventAsyncType.CHANNEL_STATUS_CHANGED: "A tenant status is changed.",
