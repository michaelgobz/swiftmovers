...
describe("As an admin I want to create product types", () => {
  ...
  it(
    "should be able to create product type without shipping required. TC: swiftmovers_1501",
  ...
  it(
    "should be able to create product type with shipping required. TC: swiftmovers_1502",
  ...
  it(
    "should be able to create product type with gift card kind. TC: swiftmovers_1510",
    { tags: ["@productType", "@allEnv", "@stable"] },
    () => {
      const name = `${startsWith}${faker.datatype.number()}`;
